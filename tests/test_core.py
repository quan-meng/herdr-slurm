...
from herdr_slurm.__main__ import new_tab
...
class CoreTests(unittest.TestCase):
    ...
    def test_explicit_agent_action_creates_and_attaches_tab(self):
        with tempfile.TemporaryDirectory() as directory:
            root = Path(directory)
            ...
            ) as create_tab, patch.object(Herdr, "attach") as attach:
                self.assertEqual(new_tab(root, config_dir, state_dir, "codex"), 0)
        create_tab.assert_called_once_with("w1", "codex")
